...
import PPserviceStack  from './pPserviceStack';
              ...
              <>
                ...
                <Drawer.Screen name="UserSignup" component={ UserSignupStack } />
                  ...
                  <> */}
                    ...
                    <Drawer.Screen name="Plus Proche Service" options={{drawerLabel: () =><Text style={globalStyles.menuText}>Plus Proche Service</Text>, drawerIcon:()=> <Image style={globalStyles.menu} source={images.menu['mapIcon']} />}} component={ PPserviceStack } />
