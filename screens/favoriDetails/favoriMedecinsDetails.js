...
export default function FavoriMedecinsDetails({route, navigation}){
    ...
    const editMedecins = (val) => {
        ...
        try {
            db.collection('medecins').doc(route.params.key).update({
                nom: val.nom,
                prenom: val.prenom,
                adresse: val.adresse,
        ...
        navigation.navigate('Favoris',val)
        setModalOpen(false);
    }
        ...
        <View style={ globalStyles.container }>
            <Modal visible={modalOpen} animationType='slide'>
                        ...
                        <View style={styles.modalContainer}>
                            <MaterialIcons name='close' size={24} style={{ ...styles.modalToggle, ...styles.modalClose}}  onPress={() =>setModalOpen(false) }/>
                                <View style={globalStyles.container}>
                                    <ScrollView>
                                    <Formik
                                    initialValues={{ nom:route.params.nom, prenom:route.params.prenom, adresse:route.params.adresse, telephone:route.params.telephone+'', email:route.params.email}}
                ...
                <TouchableOpacity onPress={ () => setmodelOpen(true)} >
                    <Text style={styles.text}>Modifer le medecin</Text>
                </TouchableOpacity>
