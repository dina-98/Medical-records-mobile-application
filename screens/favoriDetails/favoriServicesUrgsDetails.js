...
export default function FavoriServicesUrgsDetails({route, navigation}){
        ...
        <View style={ globalStyles.container }>
            <Modal visible={modalOpen} animationType='slide'>
                ...
                <TouchableOpacity onPress={ () => setModelOpen(true)} >
                    <Text style={styles.text}>Modifer la service d'urgence</Text>
                </TouchableOpacity>
