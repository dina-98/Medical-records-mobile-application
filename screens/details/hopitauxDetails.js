...
import { StyleSheet, Text, View, TextInput, Modal, Button, ScrollView, TouchableWithoutFeedback, TouchableOpacity, Keyboard } from 'react-native';
...
export default function HopitauxDetails({route, navigation}){
    ...
    const editHopitaux = (val) => {
        ...
        navigation.navigate('Hopitaux',val)
        setModalOpen(false);
    }

    const hopitauxchema = yup.object({
        ...
        <View style={ globalStyles.container }>
            <Modal visible={modalOpen} animationType='slide'>
                        ...
                        <View style={styles.modalContainer}>
                            <MaterialIcons name='close' size={24} style={{ ...styles.modalToggle, ...styles.modalClose}}  onPress={() =>setModalOpen(false) }/>
                                <View style={globalStyles.container}>
                                    ...
                                    validationSchema={hopitauxchema}
                ...
                <TouchableOpacity onPress={ () => setmodelOpen(true)} >
                    <Text style={styles.text}>Modifer hôpital ou clinique</Text>
                </TouchableOpacity>
